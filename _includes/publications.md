...
<div class="pub-row">
  ...
  <div class="col-sm-12" style="position: relative;padding-right: 15px;padding-left: 15px; margin-bottom: -10px; margin-top: -10px;">
...
{% if site.data.publications.preprints.size > 0 %}
